...
//Code Here
let postTaxPrices  = prices.map((taxPrices) => taxPrices * 1.07);
...
let bobsTotal = purchases.filter((name) => name.owner === 'Bob').map((purchase) => purchase.price).reduce((acc, cur) => acc + cur);
